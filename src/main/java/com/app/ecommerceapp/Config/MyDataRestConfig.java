...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        ...
        config.getExposureConfiguration().forDomainType(product_category.class).withItemExposure((metdata, httpMethods) -> httpMethods.disable(theUnSupportedActions)).withCollectionExposure((metdata, httpMethods) -> httpMethods.disable(theUnSupportedActions));
